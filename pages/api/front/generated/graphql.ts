...
export type GetCarsQuery = { __typename?: 'Query', cars: Array<{ __typename?: 'Car', availability: boolean, brand: string, car_id: number, category: string, description: string, fuel_type: string, mileage: number, model: string, model_year: number, price_per_day: number, seats: number, url: string }> };
